                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white shadow-2xl rounded-xl border border-gray-200 z-50 overflow-hidden animate-fadeIn">
                    ...
                    <div className="flex flex-col">
                      <Link
                        to="/my-orders"
                        className="px-4 py-2 hover:bg-gray-100 transition-colors text-gray-700"
                      >
                        My Orders
                      </Link>
                      <Link
                      ...
                      <button
                        ...
                        className="px-4 py-2 hover:bg-gray-100 transition-colors text-gray-700 text-left w-full"
                      >
                        Logout
                      </button>
                    </div>
        ...
        <div className="md:hidden fixed top-0 left-0 w-64 h-full bg-white shadow-2xl z-50 animate-slideIn overflow-y-auto">
          ...
          <nav className="flex flex-col gap-1 p-4">
            ...
            {user?._id ? (
              ...
              <Link
                to="/login"
                className="px-4 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700 transition-colors text-center"
              >
                Login
              </Link>
            )}
