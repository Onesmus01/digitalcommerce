        ...
        {banners.map((banner, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-3">
              <h1 className="text-base font-bold text-white mb-1">{banner.title}</h1>
              <p className="text-white/90 text-[11px] mb-2">{banner.desc}</p>
              <button
                onClick={(e) => {
                  e.stopPropagation();
        ...
        {banners.map((banner, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-5">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-white mb-2">{banner.title}</h1>
              <p className="text-white/90 mb-4">{banner.desc}</p>
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  navigate(banner.path);
