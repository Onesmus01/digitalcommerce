...
import {signIn,signUp,logout, getAllUsers, updateUser,addTocartController, countAddToCartProduct, addToCartView, updateAddToCart, deleteCartProduct, getTotalUsers, clearCart } from '../controller/userController.js'
...
userRouter.delete('/clear-cart',authToken,clearCart)
